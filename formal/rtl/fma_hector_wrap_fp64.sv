...
#(
  ...
  input  logic [63:0] multiplier,     // = operand A
  input  logic [63:0] multiplicand,   // = operand B
  input  logic [63:0] addend,         // = operand C
