#============================================================================
# command_script_fp16_fmadd.tcl — FP16 FNMSUB (op_i=1, op_mod=0)
...
proc run_main {} {
    ...
    puts "=== Starting FP16 FNMSUB proof ==="
    ...
    if { [proofstatus p] } {
        puts "=== FP16 FNMSUB proof SUCCEEDED (${_elapsed}s) ==="
    } else {
        puts "=== FP16 FNMSUB proof TIMED OUT or FAILED (${_elapsed}s) ==="
    }
}
