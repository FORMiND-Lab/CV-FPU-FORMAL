#============================================================================
# command_script_fp32_fnmsub.tcl — FP32 FNMSUB (op_i=1, op_mod=0)
...
proc run_main {} {
    ...
    puts "=== Starting FP32 FNMSUB proof ==="
    ...
    if { [proofstatus p] } {
        puts "=== FP32 FNMSUB proof SUCCEEDED (${_elapsed}s) ==="
    } else {
        puts "=== FP32 FNMSUB proof TIMED OUT or FAILED (${_elapsed}s) ==="
    }
}
