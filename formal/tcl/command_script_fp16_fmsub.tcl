#============================================================================
# command_script_fp16_fmadd.tcl — FP16 FMSUB (op_i=0, op_mod=1)
...
proc run_main {} {
    ...
    puts "=== Starting FP16 FMSUB proof ==="
    ...
    if { [proofstatus p] } {
        puts "=== FP16 FMSUB proof SUCCEEDED (${_elapsed}s) ==="
    } else {
        puts "=== FP16 FMSUB proof TIMED OUT or FAILED (${_elapsed}s) ==="
    }
}
