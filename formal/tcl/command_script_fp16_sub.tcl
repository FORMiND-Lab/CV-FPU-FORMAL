#============================================================================
# command_script_fp16_fmadd.tcl — FP16 SUB (op_i=2, op_mod=1)
...
proc run_main {} {
    ...
    if { [proofstatus p] } {
        puts "=== FP16 SUB proof SUCCEEDED (${_elapsed}s) ==="
    } else {
        puts "=== FP16 SUB proof TIMED OUT or FAILED (${_elapsed}s) ==="
    }
}
