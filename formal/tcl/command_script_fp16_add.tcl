#============================================================================
# command_script_fp16_fmadd.tcl — FP16 ADD (op_i=2, op_mod=0)
...
proc run_main {} {
    ...
    if { [proofstatus p] } {
        puts "=== FP16 ADD proof SUCCEEDED (${_elapsed}s) ==="
    } else {
        puts "=== FP16 ADD proof TIMED OUT or FAILED (${_elapsed}s) ==="
    }
}
