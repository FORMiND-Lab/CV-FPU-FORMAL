...
proc compile_spec {} {
    ...
    cppan -DSOFTFLOAT_FAST_INT64 -I../../../third_party/softfloat/include \
          -I../../../third_party/softfloat/source/RISCV \
          ../../spec/add_spec_fp64.cpp \
          ../../../third_party/softfloat/source/f64_add.c \
          ../../../third_party/softfloat/source/s_addMagsF64.c \
          ../../../third_party/softfloat/source/s_subMagsF64.c \
          ../../../third_party/softfloat/source/s_roundPackToF64.c \
          ../../../third_party/softfloat/source/s_normRoundPackToF64.c \
          ../../../third_party/softfloat/source/s_normSubnormalF64Sig.c \
          ...
          ../../../third_party/softfloat/source/s_mul64To128.c \
          ../../../third_party/softfloat/source/s_add128.c \
          ../../../third_party/softfloat/source/s_sub128.c \
          ../../../third_party/softfloat/source/s_shortShiftRightJam128.c \
          ../../../third_party/softfloat/source/s_shiftRightJam128.c \
          ../../../third_party/softfloat/source/s_shortShiftLeft128.c \
          ../../../third_party/softfloat/source/RISCV/s_propagateNaNF64UI.c \
...
proc compile_impl {} {
    create_design -name impl -top add_hector_wrap_fp64 -clock clock -reset resetN -negReset
    vcs -sverilog \
        ...
        ../../../third_party/cvfpu/common_cells/src/lzc_hector.sv \
        ../../../third_party/cvfpu/common_cells/src/rr_arb_tree.sv \
        ../../rtl/add_hector_wrap_fp64.sv
    compile_design impl
}
...
proc case_split_add64 {} {
    ...
    caseAssume (spec.addend(1)[62:52] != 11'h000)
    caseAssume (spec.addend(1)[62:52] != 11'h7ff)
    caseEnumerate adn1 -expr spec.multiplier[51:0] -parent A_dnorm -type leading1
    ...
    caseAssume (spec.addend(1)[62:52] != 11'h000)
    caseAssume (spec.addend(1)[62:52] != 11'h7ff)
    caseEnumerate bdn1 -expr spec.multiplicand[51:0] -parent B_dnorm -type leading1
    ...
    caseAssume (spec.multiplicand(1)[62:52] != 11'h000)
    caseAssume (spec.multiplicand(1)[62:52] != 11'h7ff)
    caseEnumerate cdn1 -expr spec.addend[51:0] -parent C_dnorm -type leading1
    ...
    caseAssume (spec.multiplier(1)[62:52] != 11'h000)
    caseAssume (spec.multiplier(1)[62:52] != 11'h7ff)
    caseEnumerate bcdn -expr spec.multiplicand[51:0] -parent BC_dnorm -type leading1
    ...
    caseAssume (spec.multiplicand(1)[62:52] != 11'h000)
    caseAssume (spec.multiplicand(1)[62:52] != 11'h7ff)
    caseEnumerate acdn -expr spec.multiplier[51:0] -parent AC_dnorm -type leading1

    caseBegin ABC_dnorm
    caseAssume (spec.multiplier(1)[62:52] == 11'h000)
    caseAssume (spec.multiplicand(1)[62:52] == 11'h000)
    caseAssume (spec.addend(1)[62:52] == 11'h000)
    caseEnumerate abcdn -expr spec.multiplier[51:0] -parent ABC_dnorm -type leading1
}
...
proc run_main {} {
    ...
    set_hector_case_splitting_procedure "case_split_add64"
    ...
    puts "=== $_label elapsed: [expr {$t1-$t0}] seconds ==="
    listlemmas
    listproofs
}