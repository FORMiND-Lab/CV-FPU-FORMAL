#============================================================================
# command_script_fp32_fnmadd.tcl — FP32 FNMADD (op_i=1, op_mod=1)
...
proc run_main {} {
    ...
    puts "=== Starting FP32 FNMADD proof ==="
    ...
    if { [proofstatus p] } {
        puts "=== FP32 FNMADD proof SUCCEEDED (${_elapsed}s) ==="
    } else {
        puts "=== FP32 FNMADD proof TIMED OUT or FAILED (${_elapsed}s) ==="
    }
}
