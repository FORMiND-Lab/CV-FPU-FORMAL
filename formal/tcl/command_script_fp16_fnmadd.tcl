#============================================================================
# command_script_fp16_fmadd.tcl — FP16 FNMADD (op_i=1, op_mod=1)
...
proc run_main {} {
    ...
    puts "=== Starting FP16 FNMADD proof ==="
    ...
    if { [proofstatus p] } {
        puts "=== FP16 FNMADD proof SUCCEEDED (${_elapsed}s) ==="
    } else {
        puts "=== FP16 FNMADD proof TIMED OUT or FAILED (${_elapsed}s) ==="
    }
}
