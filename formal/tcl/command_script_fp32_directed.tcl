...
proc run {} {
    ...
    puts "=== Starting FP32 Directed (11 cases) proof ==="
    ...
    if { [proofstatus p] } {
        puts "=== FP32 Directed (11 cases) proof SUCCEEDED (${_elapsed}s) ==="
    } else {
        puts "=== FP32 Directed (11 cases) proof TIMED OUT or FAILED (${_elapsed}s) ==="
    }
}
