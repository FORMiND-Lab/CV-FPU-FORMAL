#============================================================================
# command_script_fp32_fmsub.tcl — FP32 FMSUB (op_i=0, op_mod=1)
...
proc run_main {} {
    ...
    puts "=== Starting FP32 FMSUB proof ==="
    ...
    if { [proofstatus p] } {
        puts "=== FP32 FMSUB proof SUCCEEDED (${_elapsed}s) ==="
    } else {
        puts "=== FP32 FMSUB proof TIMED OUT or FAILED (${_elapsed}s) ==="
    }
}
