#!/bin/bash
#=============================================================================
# run_fp32.sh — FP32 Formal Verification (Hector DPV)
#
# Usage (inside EDA Docker container):
#   cd /home/eda
#   ./formal/scripts/run_fp32_fmadd.sh <operation>
#
# Operations:
...
#
# Examples:
#   ./formal/scripts/run_fp32_fmadd.sh fmadd
#   ./formal/scripts/run_fp32_fmadd.sh mul
#=============================================================================
...
if [ "$CURRENT_DIR" != "$PROJ_DIR" ]; then
    ...
    echo "  cd $PROJ_DIR"
    echo "  ./formal/scripts/run_fp32_fmadd.sh <operation>"
    exit 1
fi
...
declare -A TCL_MAP=(
    ["fmadd"]="command_script_fp32_fmadd.tcl"
    ["fmsub"]="command_script_fp32_fmsub.tcl"
    ["fnmsub"]="command_script_fp32_fnmsub.tcl"
    ["fnmadd"]="command_script_fp32_fnmadd.tcl"
    ["add"]="command_script_fp32_add.tcl"
    ["sub"]="command_script_fp32_sub.tcl"
    ["mul"]="command_script_fp32_mul.tcl"
)
...
run_op() {
    ...
    local run_dir="$RUN_DIR/fp32_$op"
    local tmp_dir="/tmp/hector_qsub_fp32_$op"
